...
namespace OpenXmlUtilities
{
    public class clsOpenXmlExcelUtilities
    {
        ...
        private static SheetData GenerateSheetdataForDetails(List<Dictionary<string, string>> data)
        {
        ...
        private static Row CreateHeaderRowForExcel(List<Dictionary<string, string>> header)
        {
            Row workRow = new Row();
        ...
        private static Row GenerateRowForChildPartDetail(Dictionary<string, string> datas)
        {
            Row tRow = new Row();
